...
exports.ChatMessageDto = exports.ChatHistoryItemDto = void 0;
...
exports.ChatHistoryItemDto = ChatHistoryItemDto;
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The user message' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], ChatMessageDto.prototype, "message", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: [ChatHistoryItemDto], required: false }),
